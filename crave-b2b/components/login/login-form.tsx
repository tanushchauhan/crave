  ...
  return (
    <div className="w-full max-w-[400px] space-y-8">
      ...
      <form className="space-y-6" noValidate>
        ...
        <Button
          type="submit"
          className="h-11 w-full rounded-lg bg-brand text-base font-bold text-white shadow-none hover:bg-brand/90 focus-visible:ring-2 focus-visible:ring-brand/40"
        >
          Login
        </Button>
      </form>
