-- Dashboard KPIs for B2B owner: booking counts, party averages, covers, sentiment from item_feedback.
-- Uses UTC day boundaries for "today" / "yesterday" (matches typical Supabase project TZ).
